...
public class Aluno { 
    ...
    public void consultarFrequencias() {
        System.out.println("Frequencias do aluno " + nome + ":");
        if (disciplinas == null) {
            System.out.println("Nenhuma disciplina cadastrada.");
            return;
        }
        for (Disciplina d : disciplinas) {
            System.out.println(d.getNome() + ": frequencia não registrada."); 
        }
    }
    ...
    public void consultarComprovanteMatricula() {
        ...
        System.out.println("Responsael: " + responsavel);
      
    }

    public void consultarGradeDeHorario() {
        System.out.println("Grade de Horarios de " + nome + ":");
